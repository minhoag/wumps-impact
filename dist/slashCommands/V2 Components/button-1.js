...
// /button-1
const { SlashCommandBuilder, MessageFlags, ButtonBuilder, ButtonStyle, SectionBuilder, TextDisplayBuilder, ContainerBuilder } = require('discord.js');
module.exports = {
    public: true,
    ...
    run: async (client, interaction) => {
        ...
        const section = new SectionBuilder()
            .addTextDisplayComponents(new TextDisplayBuilder().setContent('🔗 Click the button to join support'))
