...
const { SlashCommandBuilder, MessageFlags, MediaGalleryBuilder, MediaGalleryItemBuilder, ContainerBuilder } = require('discord.js');
module.exports = {
    public: true,
    ...
    run: async (client, interaction) => {
        ...
        const gallery = new MediaGalleryBuilder().addItems(new MediaGalleryItemBuilder()
