...
const { SlashCommandBuilder, MessageFlags, SectionBuilder, TextDisplayBuilder, ThumbnailBuilder, ContainerBuilder } = require('discord.js');
module.exports = {
    public: true,
    ...
    run: async (client, interaction) => {
        ...
        const section = new SectionBuilder()
            .addTextDisplayComponents(new TextDisplayBuilder().setContent('📄 **Section Title**'), // Title text
