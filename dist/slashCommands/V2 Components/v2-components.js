...
const { MessageFlags, TextDisplayBuilder, SeparatorBuilder, SeparatorSpacingSize, ThumbnailBuilder, SectionBuilder, ChannelSelectMenuBuilder, ActionRowBuilder, ContainerBuilder, MediaGalleryBuilder, MediaGalleryItemBuilder, ButtonBuilder, ButtonStyle, FileBuilder, AttachmentBuilder, SlashCommandBuilder } = require('discord.js');
...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        const sectionWithThumbnail = new SectionBuilder()
            .addTextDisplayComponents(new TextDisplayBuilder().setContent('📄 **Section Title**'), new TextDisplayBuilder().setContent('This is a description inside a Section component, with a thumbnail.'))
        ...
        // Media Gallery
        const mediaGallery = new MediaGalleryBuilder().addItems(new MediaGalleryItemBuilder().setURL('https://raw.githubusercontent.com/ZarScape/ZarScape/refs/heads/main/images/ZarScape/logo-with-background.png'), new MediaGalleryItemBuilder().setURL('https://raw.githubusercontent.com/ZarScape/ZarScape/refs/heads/main/images/ZarScape/logo-with-background.png'));
        ...
        const container = new ContainerBuilder()
            ...
            .addMediaGalleryComponents(new MediaGalleryBuilder().addItems(new MediaGalleryItemBuilder().setURL(botAvatarURL)))
            .addSectionComponents(...sectionWithButtons)
            .addSeparatorComponents(new SeparatorBuilder().setDivider(true).setSpacing(SeparatorSpacingSize.Small))
            .addTextDisplayComponents(new TextDisplayBuilder().setContent('📝 **This message is fully composed of Components V2.**'), new TextDisplayBuilder().setContent('- Use TextDisplay for static text.'), new TextDisplayBuilder().setContent('- Use Section for grouping text with accessories.'), new TextDisplayBuilder().setContent('- Use MediaGallery for images/carousels.'), new TextDisplayBuilder().setContent('- Use Separator for dividing blocks of content.'), new TextDisplayBuilder().setContent('- Use File to attach JSON, images, or other files.'), new TextDisplayBuilder().setContent('- Use Button as interactive links or actions.'), new TextDisplayBuilder().setContent('- Use ChannelSelectMenu to let users pick a channel.'))
