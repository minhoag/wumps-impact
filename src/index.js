...
process.on('uncaughtException', function (error) {
    ...
    if (error instanceof Error &&
        ...
        var stackLines = (_a = error.stack) === null || _a === void 0 ? void 0 : _a.split('\n');
        var relevantLine = stackLines === null || stackLines === void 0 ? void 0 : stackLines.find(function (line) {
        ...
        if (error.code === 'ENOTFOUND') {
            ...
            console.log('Unknown Interaction. Time stamp: ', dayjs().format('YYYY-MM-DD HH:mm:ss'));
        }
        else if (error.code === 10008) {
            console.log('Message is deleted. Time stamp: ', dayjs().format('YYYY-MM-DD HH:mm:ss'));
        }
        else {
            console.log('Uncaught Exception: Discord API Error. Error: ', error.message);
        }
    }
    else {
...
client.login(process.env['DiSCORD_TOKEN']).then(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
    return [2 /*return*/];
}); }); });
