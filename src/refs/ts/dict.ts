...
export const Locale: {
  ...
  registererror: {
    ...
    'en-US':
      'Use command `/register` to create a new server account. If you already created a new server account but met this error. please contact admin to resolve the issue',
  },
  generalerror: {
    vi: 'Đã có lỗi xảy ra. Không thể lấy thông tin túi. Vui lòng thử lại hoặc liên hệ admin để hỗ trợ!',
    'en-US':
      'Error occured. Cannot fetch your item information. Please contact admin for assistance!',
  },
  notresponse: {
    vi: 'Không có xác nhận trong vòng 1 phút, huỷ nhận lệnh.',
    'en-US':
      'Confirmation not received within 1 minute, cancelling command.',
  },
  'title:pending': {
    vi: 'Cả hai bên phải đồng ý thì giao dịch sau đây mới có thể diễn ra!',
    'en-US':
      'Both end must agree for the following trade to take place!',
  },
  'title:success': {
  ...
  'buy:instruction': {
    ...
    'en-US':
      'To buy the item, use command `buy points <\/ID>` to buy it.',
  },
  'buy:howto': {
    vi:
      'Xem và chọn cửa hàng bạn muốn sử dụng tiền của mình.\n\n' +
    ...
    'en-US':
      'View and choose the shop you want to spend your currency on.\n\n' +
  ...
  'buy:insufficient': {
    ...
    'en-US':
      'You have insufficient to purchase. If you believe that this is a mistake, contact admin to resolve.',
  },
  'buy:success': {
