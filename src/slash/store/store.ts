...
export const ShopView: ShopItem[] = [
  {
    ...
    quality: 3,
    quantity: 1,
    assets: '<:FragileResin:1257820100325539861>',
    description: {
  ...
  },
  {
    ...
    quantity: 1,
    quality: 5,
    assets: '<:IntertwinedFate:1184076475813597187>',
    description: {
  ...
  },
  {
    ...
    quantity: 1,
    quality: 5,
    assets: '<:CrownofInsight:1262128515533508671>',
    description: {
  ...
  },
  {
    ...
    price: 5_000_000,
    quantity: 1,
    assets: '<:AcquaintFate:1184076479324229652>',
    quality: 5,
    description: {
      'en-US':
  ...
  },
  {
    ...
    quantity: 5,
    quality: 2,
    assets: '<:MaterialBundle:1263397840164487289>',
    description: {
      'en-US':
  ...
  },
  {
    ...
    quantity: 1,
    quality: 5,
    assets: '<:DomainReliquary:1263401902247247962>',
    description: {
      'en-US':
        'The Reliquary Box contains either **Desert Pavilion Chronicle** or **Flower of Paradise Lost**.',
